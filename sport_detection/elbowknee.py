...
with open('models\pickle\elbowknee.pkl', 'rb') as f:
    model = pickle.load(f)
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        if body_language_class == 'right' and body_language_prob[body_language_prob.argmax()] >= .8:
            current_stage = 'right'
        elif current_stage == 'right' and body_language_class == 'left' and body_language_prob[body_language_prob.argmax()] >= .8:
            current_stage = 'left'
            counter +=1
            print(current_stage)
